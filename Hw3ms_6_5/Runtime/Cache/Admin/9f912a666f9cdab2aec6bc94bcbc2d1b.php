    ...
    <div class="col-xs-12">
             <div class="tabbable">
                   <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab">
                       ...
                       <li> <a href="<?php echo U('Admin/Video/indexShowSet',array('nav'=>I('nav'),'cate'=>I('cate')));?>">首页展示管理</a></li>
                        ...
                        <form class="" action="<?php echo U('order');?>" method="post">
                           ...
                           <tfoot class="tt">
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                    <td  width="2%" class="ym"> <input class="input-medium" style="width:40px;height:25px;" type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['order_number']); ?>" readonly="">
                                    </td>
                                    <td width="10%"><img width="100%" src="/web/Hw3ms/<?php echo ($v['img']); ?>" alt=""/></td>
                                    <td width="10%"><?php echo ($v['name']); ?></td>
                                    <td width="15%"><?php echo ($v['name_en']); ?></td>
                                    <td><?php echo ($v['url']); ?></td>
                                    <td><?php echo ($v['url_en']); ?></td>
                                    <td><?php echo ($v['createtime']); ?></td>
                                    <td width="5%"><?php echo ($v['state']); ?></td>
                                    <td width="25%">  
                                         <a href="javascript:;" vId="<?php echo ($v['id']); ?>" vName="<?php echo ($v['name']); ?>" vName_en="<?php echo ($v['name_en']); ?>" vUrl="<?php echo ($v['url']); ?>" vUrl_en="<?php echo ($v['url_en']); ?>" vImg="<?php echo ($v['img']); ?>" onclick="edit(this)">修改</a> | 
                                         <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('delete',array('id'=>$v['id']));?>'">删除</a> |
                                          <?php if($v['status'] == '0'): ?><a href="#" vId="<?php echo ($v['id']); ?>" onclick="index_show(this,'1')"> 首页显示</a> 
                                          <?php else: ?>
                                          <a href="#" vId="<?php echo ($v['id']); ?>" onclick="index_show(this,'0')"> 取消首页显示</a><?php endif; ?>
                                    </td>
            ...
            <div class="modal-dialog">
                 <div class="modal-content">
                     ...
                     <div class="modal-body">
                          <form id="bjy-form" class="form-inline" action="<?php echo U('add');?>" method="post" enctype="multipart/form-data"> 
                                  <table class="table table-striped table-bordered table-hover table-condensed">
