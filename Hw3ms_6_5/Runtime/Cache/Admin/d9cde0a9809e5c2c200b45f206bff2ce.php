                   ...
                   <div class="tab-content">
                        <!-- <form class="" action="<?php echo U('order');?>/nav/<?php echo I('get.nav');?>" method="post">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                    <td class="ym"> <input class="input-medium suo<?php echo ($v['_level']); ?>" style="width:40px;height:25px;" type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['order_number']); ?>">
                                    </td>
                                    ...
                                    <td> 
                                         ...
                                         <?php if($v['haschild']=='0'){ ?>
                                                |<a href="<?php echo U('Admin/Ziliao/index',array('nav'=>I('get.nav'),'cate'=>$v['id']));?>" > 查看资料</a>
                                         <?php }?>
                          ...
                          <div class="box box<?php echo ($v['id']); ?>">
                           ...
                           <?php if(is_array($v['_data'])): foreach($v['_data'] as $key=>$n): ?><div>
                              <div class="btnBG">
                                ...
                                <div class="li5">
                                   <a href="javascript:;" cateId="<?php echo ($n['id']); ?>" navName="<?php echo ($n['name']); ?>" onclick="add_child(this)">添加子菜单</a> | <a href="javascript:;" cateId="<?php echo ($n['id']); ?>" cateName="<?php echo ($n['name']); ?>" cateName_en="<?php echo ($n['name_en']); ?>" cateNum="<?php echo ($n['order_num']); ?>" onclick="edit(this)">修改</a> | <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('delete',array('id'=>$n['id']));?>'">删除</a>
                                   <?php if($n['haschild']=='0'){ ?>
                           ...
                           <?php if(is_array($n['_data'])): foreach($n['_data'] as $key=>$u): ?><div>
                                  <div class="btnBG">
                                    ...
                                    <div class="li5">
                                       <a href="javascript:;" cateId="<?php echo ($u['id']); ?>" navName="<?php echo ($u['name']); ?>" onclick="add_child(this)">添加子菜单</a> | <a href="javascript:;" cateId="<?php echo ($u['id']); ?>" cateName="<?php echo ($u['name']); ?>" cateName_en="<?php echo ($u['name_en']); ?>" cateNum="<?php echo ($u['order_num']); ?>" onclick="edit(this)">修改</a> | <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('delete',array('id'=>$u['id']));?>'">删除</a>
                                       <?php if($u['haschild']=='0'){ ?>
