...
<div class="main-container" id="main-container">
  ...
  <link rel="stylesheet" href="/web/Hw3ms/Public/statics/css/drop.css" />
         ...
         <div class="col-xs-12">
                   ...
                   <div class="tab-content">
                       <!--  <form class="" action="<?php echo U('Admin/Nav/order');?>" method="post">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                    <td> <input class="input-medium" style="width:40px;height:25px;" type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['order_number']); ?>"></td>
                                    <td><?php echo ($v['_name']); ?></td>
                                    <td><?php echo ($v['name_en']); ?></td>
                                    <td><?php echo ($v['mca']); ?></td>
                                    <td> <a href="javascript:;" navId="<?php echo ($v['id']); ?>" navName="<?php echo ($v['name']); ?>" onclick="add_child(this)">添加子菜单</a> | <a href="javascript:;" navId="<?php echo ($v['id']); ?>" navName="<?php echo ($v['name']); ?>" navName_en="<?php echo ($v['name_en']); ?>" navMca="<?php echo ($v['mca']); ?>" navIco="<?php echo ($v['ico']); ?>" onclick="edit(this)">修改</a> | <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Nav/delete',array('id'=>$v['id']));?>'">删除</a>
                                    </td>
                                </tr><?php endforeach; endif; ?>
                                <tr>
                                       <td colspan="6"><input class="btn btn-success" type="submit" value="排序"></td>
                                </tr>
                            </table>
                       </form> -->
             ...
             <form class="order_table" action="<?php echo U('Admin/Nav/order');?>" method="post">
                  <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="droptarget droptarget<?php echo ($v['id']); ?>">
                        <div>
                          <div class="btnBG">
                              ...
                              <div class="li4"><?php echo ($v['mca']); ?></div>
                              <div class="li5">
                                 <a href="javascript:;" navId="<?php echo ($v['id']); ?>" navName="<?php echo ($v['name']); ?>" onclick="add_child(this)">添加子菜单</a> | <a href="javascript:;" navId="<?php echo ($v['id']); ?>" navName="<?php echo ($v['name']); ?>" navName_en="<?php echo ($v['name_en']); ?>" navMca="<?php echo ($v['mca']); ?>" navIco="<?php echo ($v['ico']); ?>" onclick="edit(this)">修改</a> | <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Nav/delete',array('id'=>$v['id']));?>'">删除</a>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="box box<?php echo ($v['id']); ?>">
                           ...
                           <?php if(is_array($v['_data'])): foreach($v['_data'] as $key=>$n): ?><div>
                              <div class="btnBG">
                                ...
                                <div class="li4"><?php echo ($n['mca']); ?></div>
                                <div class="li5">
                           ...
                           <?php if(is_array($n['_data'])): foreach($n['_data'] as $key=>$u): ?><div>
                                  <div class="btnBG">
                                    ...
                                    <div class="li4"><?php echo ($u['mca']); ?></div>
                                    <div class="li5">
