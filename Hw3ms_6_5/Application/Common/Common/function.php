...
function send_email($address, $subject, $content)
{
    ...
    if (empty($email_smtp) || empty($email_username) || empty($email_password) || empty($email_from_name)) {
        // var_dump($email_smtp, $email_username, $email_password, $email_from_name);
...
function pdf($html = '<h1 style="color:red">hello word</h1>')
{
    ...
    // var_dump(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);die;
...
function array_depth($arr) //判断数组的深度
